...
<div class="site-wrap">
    ...
    <div class="site-blocks-cover overlay" style="background-image: url(images/hero_conference.jpg);" data-aos="fade"
                ...
                <div class="col-12  block-13">
                    <div class="owl-carousel nonloop-block-13">
                        ...
                        <div id="featured1" class="d-block d-md-flex listing vertical">
                            <a href="listings-single.php" class="img d-block"
                               style="background-image: url('images/img_1.jpg')"></a>
                            <div class="lh-content">
                                <span class="category">Cars &amp; Vehicles</span>
                                <a href="#" class="bookmark"><span class="icon-heart"></span></a>
                                <h3><a href="listings-single.php">Red Luxury Car</a></h3>
                        ...
                        <div id="featured2" class="d-block d-md-flex listing vertical">
                            ...
                            <div class="lh-content">
                                ...
                                <a href="#" class="bookmark"><span class="icon-heart"></span></a>
                                <h3><a href="listings-single.php">House with Swimming Pool</a></h3>
                                <address>Don St, Brooklyn, New York</address>
                                <p class="mb-0">
                                    <span class="icon-star text-warning"></span>
                                    <span class="icon-star text-warning"></span>
